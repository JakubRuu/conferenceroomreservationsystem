...
class OrganizationController {
    ...
    Organization add(@Validated(value = AddOrganization.class ) @RequestBody Organization organization){
         return organizationService.addOrganizations(organization);
    }
    @PutMapping ("/{name}")
    ...
    Organization delete(@PathVariable String name){
         return organizationService.deleteOrganizations(name);
    }
    ...
    ResponseEntity<Object> handlerNoSuchElementException(NoSuchElementException e ){
